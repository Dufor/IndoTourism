...
Теперь к недочетам:
1. Нет шрифта из макета. Поэтому же и не сделаны правильные font-weight'ы.
2. Общий pixelperfect. Особенно в хедере и блоке с картинками заметно.
3. Тень у хедера? Или же нужно сделать через inset у main'a. Через inset не понимаю как сделать тень на одну сторону.
4. Кнопка "Ok ask me" - верхняя тень inset не сделана.
5. Названия некоторых классов не нравятся. Нужно более общее, а не "places43" из названия контента.
